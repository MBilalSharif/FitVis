...
const splashScreen = () => {
  ...
  const handlePress = () => {
    // Press animation - scale then navigate
    Animated.sequence([
      Animated.timing(pulseAnim, {
        toValue: 0.95,
        duration: 100,
      ...
      router.push('/registration/registration1');
    });
  };

  return (
    <SafeAreaView style={styles.container}>
      {/* Animated dumbbell decorations */}
      <Animated.View style={[
        styles.dumbbell,
        styles.dumbbell1,
        { 
          transform: [
            { translateY: dumbbell1Y },
            { rotate: '-15deg' }
          ] 
        }
      ]}>
      ...
      <Animated.View style={[styles.content, { opacity: fadeAnim }]}>
        ...
        <Animated.Text style={[
          ...
          SMASH YOUR GOALS
          {'\n'}
          <Text style={styles.subtitleHighlight}>SMART • FAST • STRONG</Text>
        </Animated.Text>
      </Animated.View>
